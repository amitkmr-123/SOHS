...
# SOHS for the HubSpot CMS by New Breed
...
```
hs fetch sohs/modules/u4m-000.module src/modules/u4m-000.module -o
```

hs fetch sohs/modules/u4m-cards-side.module src/modules/u4m-cards-side.module -o

#### Watch entire folder on non-default portal (portal names are set in hubspot.config.yml)

```
hs watch --account=hug_vt src sohs
```
